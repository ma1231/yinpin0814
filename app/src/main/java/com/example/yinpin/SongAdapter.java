...
public class SongAdapter extends ArrayAdapter<song1> {
    private int resourceId;

    SongAdapter(Context context, int textViewResourceId, List<song1> objects){ //ArrayList or List
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent){
        song1 song = getItem(position);//获取当前项song的实例
        View view;
        if(convertView == null){
